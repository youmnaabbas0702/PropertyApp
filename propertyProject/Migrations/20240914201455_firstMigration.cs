...
namespace propertyProject.Migrations
{
    ...
    public partial class firstMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Admin",
                columns: new[] { "Id", "CityId", "Email", "Password" },
                values: new object[,]
                {
                    { 1, 1, "Admin11.EasyStay@gmail.com", "admin11#*33" },
                    { 2, 2, "Admin22.EasyStay@gmail.com", "admin22#*44" },
                    { 3, 3, "Admin33.EasyStay@gmail.com", "admin33#*55" }
                });
